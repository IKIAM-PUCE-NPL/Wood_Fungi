...
data <- read_from_excel(file = "Data/Data_to_notame/MZmine_Feature_List_to_notame.xlsx",
                        sheet = 2, corner_row = 4, corner_column = "G", 
...
mode <- flag_detection(mode, qc_limit = 0.70, group_limit = 0) # 66% o-Xylene
                                                               # 50% 3-Hydroxy-3-phenylpropanenitrile
...
The PQN normalized and autoscaled scaled data will be used.

```{r echo=TRUE, message=FALSE, warning=FALSE, error=FALSE, results='hide'}

# Extracting identified metabolite data
upset_set <- scl_set[!is.na(scl_set@featureData@data$Metabolite),]
